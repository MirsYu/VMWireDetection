...
{
    public class _ImageArithmeticTool
    {
        public UserControl_CamShow _Render;
        public CMvdImage _Image1;
        public CMvdImage _Image2;
        public CMvdShape _Roi;
        public CMvdImage _ResultImage;

        public CImageArithmeticTool _tool = null;

        public _ImageArithmeticTool()
        {
            _tool = new CImageArithmeticTool();
        }
        ...
        public bool Run()
        {
            ...
            try
            {
                ...
                _tool.InputImage1 = _Image1;
                _tool.InputImage2 = _Image2;
                _tool.ROI = _Roi;
                _tool.Run();
